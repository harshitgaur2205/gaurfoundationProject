...
const page = () => {
    var data = [
        ...
        },
        {
            id:6,
            title:"Empower Women",
            detail:"We believe in the power of women to uplift their communities. We provide skill development training, healthcare services."
        },
        {
            id:7,
            title:"Promote Healthcare",
  ...
  return (
    <div className='about_page'>
        ...
        <div className='contact_main'>
            <h1>About Us</h1>
            <h3>Know us more to Trust us more</h3>
        </div>
      ...
      <motion.h3
        ...
        >Gaur's Foundation: Bridging Urban Communities through Support and Generosity.</motion.p >
      </div>
        ...
        >At Gaur's Foundation, our mission is simple yet profound: to unite urban communities in a shared purpose of compassion, donation, and support. We understand the strength that lies within urban areas and aim to harness this strength for the betterment of society.</motion.h4>
        </div>
      </div>
